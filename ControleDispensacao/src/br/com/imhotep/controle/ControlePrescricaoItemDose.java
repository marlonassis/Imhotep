...
public class ControlePrescricaoItemDose extends PadraoControle{
	...
	public boolean gravaPrescricaoItemDose(Dose dose) throws ExcecaoControlePrescricaoItemDose {
		...
		try{
			...
			e.printStackTrace();
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,"Ocorreu ao gravar a o item da prescri‹o.", "Utilize o material de apoio para precrever atŽ o sistema voltar ao normal."));
