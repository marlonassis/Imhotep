...
public class SolicitacaoMedicamentoUnidadeConsultaRaiz  extends ConsultaGeral<SolicitacaoMedicamentoUnidade>{
	...
	public static final String SIGLA_SOLICITACAO_ALMOXARIFADO = "Solicita��o ao Almoxarifado";
	public static final String SIGLA_SOLICITACAO_FARMACIA = "Solicita��o � Farm�cia";
	public static final String SIGLA_DEVOLUCAO_ALMOXARIFADO = "Devolu��o ao Almoxarifado";
	public static final String SIGLA_DEVOLUCAO_FARMACIA = "Devolu��o para � Farm�cia";
