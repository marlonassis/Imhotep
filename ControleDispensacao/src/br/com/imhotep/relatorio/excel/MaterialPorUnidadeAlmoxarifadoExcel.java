...
public class MaterialPorUnidadeAlmoxarifadoExcel  extends RelatorioExcel {

	List<RelMaterialPorUnidade> list;
	
	public MaterialPorUnidadeAlmoxarifadoExcel( List<RelMaterialPorUnidade> list, String setor, String periodo, int qtdColunas ){
	...
	public void gerarPlanilha() {
		...
		criarLinha("", (short)7);
		String[] header = { "Material", "Código", "Solicitada", "Atendida", "Grupo", "Subgrupo"};
