...
@ManagedBean
@ViewScoped
public class RelatorioMaterialCompletoAlmoxarifado extends PadraoRelatorio{
	
	private static final long serialVersionUID = 1L;
	
	public void gerarRalatorio() throws ClassNotFoundException, IOException, JRException, SQLException {
		String caminho = Constantes.DIR_RELATORIO + "RelatorioMaterialAlmoxarifadoCompleto.jasper";
		...
		map.put("nomeRelatorio", "Materiais Padronizados");
