...
public class InventarioAlmoxarifado implements Serializable {
	private static final long serialVersionUID = 4358138004161846856L;
	...
	public int getIdInventarioAlmoxarifado() {
		return idInventarioAlmoxarifado;
	}
	...
	public boolean getFechado(){
		if(getTipoStatus() != null && getTipoStatus().equals(TipoStatusInventarioEnum.F)){
			return true;
		}else{
			return false;
		}
