...
public class BloqueioLoteRaiz extends PadraoRaiz<Estoque>{
	...
	public boolean enviar() {
		super.mensagem("N�o � permitido inserir um estoque", "Inser��o n�o autorizada.", Constantes.ERROR);
		return false;
	}
	
	@Override
	public boolean apagar() {
		super.mensagem("N�o � permitido apagar um estoque", "Dele��o n�o autorizada", Constantes.ERROR);
		return false;
	}
