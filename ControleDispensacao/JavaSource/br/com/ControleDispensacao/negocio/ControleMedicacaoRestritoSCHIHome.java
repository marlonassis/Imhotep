...
public class ControleMedicacaoRestritoSCHIHome extends PadraoHome<ControleMedicacaoRestritoSCHI>{
	...
	public void setCarregarInstancia(ControleMedicacaoRestritoSCHI controleMedicacaoRestritoSCHI){
		setInstancia(controleMedicacaoRestritoSCHI);
		carregarMedicamentosPendentes(controleMedicacaoRestritoSCHI.getIdControleMedicacaoRestritoSCHI(), getItensLiberacao());
	}
	
	private void carregarMedicamentosPendentes(int idControleMedicacaoRestritoSCHI, List<PrescricaoItem> itensLiberacao){
		...
		String hql = "select o from PrecricaoItem o where o.controleMedicacaoRestritoSCHI.idControleMedicacaoRestritoSCHI = :idControleMedicacaoRestritoSCHI";
