...
public class Grupo {
	...
	private TipoStatusEnum tipoObrigatorio;
	...
	@Column(name = "flg_tipo_obrigatorio")
	@Enumerated(EnumType.STRING)
	public TipoStatusEnum getTipoObrigatorio() {
		return this.tipoObrigatorio;
	}

	public void setTipoObrigatorio(TipoStatusEnum tipoObrigatorio) {
		this.tipoObrigatorio = tipoObrigatorio;
	}
